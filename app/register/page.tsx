...
export const metadata = {
  title: "Create an account — Foonitas",
  description: "Create your Foonitas account and start a collaboration request.",
};
  ...
  return (
    <AuthLayout>
      ...
      <div className="mb-8">
        ...
        <p className="mt-4 max-w-md text-sm leading-6 text-white/50">Create your account to manage applications and collaborate with the Foonitas publishing workflow.</p>
      </div>
      <form className="space-y-5" action="#" method="post">
        ...
        <label className="flex items-start gap-3 text-sm leading-5 text-white/45"><input type="checkbox" name="terms" required className="mt-1 accent-[#ff5a1f]" /> I agree to the terms and acknowledge the Foonitas publishing workflow.</label>
