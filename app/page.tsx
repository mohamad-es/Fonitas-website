    ...
    <main className="overflow-hidden">
      ...
      <section className="relative border-b border-white/[0.08] pt-20">
        ...
        <div className="relative mx-auto grid max-w-[1400px] items-center gap-12 px-6 py-14 sm:py-16 lg:grid-cols-[1.05fr_.95fr] lg:gap-6 lg:px-10 lg:py-20">
          <div className="relative z-10">
            <p className="reveal-up mb-8 text-xs font-semibold uppercase tracking-[0.28em] text-[#ff6a2a]">
            ...
            <h1 className="font-display glow-text reveal-up reveal-delay-1 max-w-5xl text-[clamp(4rem,9vw,9.5rem)] font-semibold leading-[0.84]">
              ...
              application
              <br />
              <span className="text-white/30">to market.</span>
            </h1>
            <div className="reveal-up reveal-delay-2 mt-9 flex max-w-2xl flex-col gap-6 sm:mt-10 sm:flex-row sm:items-end">
              <p className="max-w-xl text-[15px] leading-7 text-white/50 sm:text-base">
                Fonitas connects application intake, evaluation, contracts, QA, publishing and the financial lifecycle
                in one operating system.
              </p>
              <a
                href="#how-it-works"
                className="group flex shrink-0 items-center gap-3 text-sm font-medium transition hover:text-white/80"
              >
                See how it works{" "}
                <span className="text-[#ff5a1f] transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1">
                  <Arrow />
                </span>
              </a>
            </div>
            <div className="reveal-up reveal-delay-3 mt-16 flex items-center gap-4 text-[10px] uppercase tracking-[0.24em] text-white/25">
              ...
              Built around the application lifecycle
            </div>
          </div>
      ...
      <section className="border-b border-white/[0.08]">
        <div className="mx-auto grid max-w-[1400px] gap-10 px-6 py-20 lg:grid-cols-[.7fr_1.3fr] lg:px-10 lg:py-28">
          ...
          <div className="max-w-3xl text-lg leading-8 text-white/45 sm:text-xl">
            <p>
              Fonitas is designed as an <span className="text-white/80">Application Publishing Operating System</span> —
              not just an app registration form, store publishing tool, dashboard or payment system.
            </p>
            <p className="mt-6">
              It connects the operational steps around an application so developers and organizations can move from
              collaboration to publishing and financial close through one accountable lifecycle.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1400px] px-6 py-28 lg:px-10 lg:py-40">
          <div className="mb-12 flex items-end justify-between gap-6 sm:mb-16">
            <div>
              ...
              <h2 className="font-display max-w-4xl text-5xl font-semibold leading-[.9] sm:text-7xl">
                Controlled releases.
                <br />
                <span className="text-white/30">Clear responsibility.</span>
              </h2>
            </div>
            <a href="#contact" className="hidden text-sm text-white/50 transition hover:text-white sm:block">
          ...
          <div className="mb-12 flex items-end justify-between gap-6 sm:mb-14">
            <div>
              ...
              <h2 className="font-display max-w-4xl text-5xl font-semibold leading-[.9] sm:text-7xl">
                A platform that can
                <br />
                <span className="text-white/30">grow around the core.</span>
              </h2>
            </div>
          </div>
          <InsightsShowcase />
      ...
      <section className="border-b border-white/[0.08] bg-[#ff5a1f] text-black">
        <div className="mx-auto flex max-w-[1400px] flex-col gap-8 px-6 py-16 sm:flex-row sm:items-end sm:justify-between lg:px-10 lg:py-20">
          <div>
            <p className="text-[10px] font-semibold uppercase tracking-[.25em] text-black/55">
              Ready when the application is
            </p>
            <h2 className="font-display mt-4 max-w-3xl text-4xl font-semibold leading-[.9] sm:text-6xl">
              Start with the application. We&apos;ll map the path.
            </h2>
          </div>
          <a
            href="#contact"
            className="inline-flex shrink-0 items-center justify-center rounded-full bg-black px-6 py-3.5 text-sm font-semibold text-white transition hover:bg-black/80"
          >
            Submit a collaboration request <span className="ml-3">↗</span>
          </a>
        </div>
      </section>
      ...
      <footer className="border-t border-white/[0.08] bg-[#070707]">
        <div className="mx-auto max-w-[1400px] px-6 py-14 lg:px-10 lg:py-16">
          <div className="grid gap-12 md:grid-cols-[1.3fr_.7fr_.7fr_.7fr]">
            <div>
              <a href="#" className="text-2xl font-bold tracking-[-.05em]">
                Fonitas<span className="text-[#ff5a1f]">.</span>
              </a>
              <p className="mt-5 max-w-xs text-sm leading-6 text-white/35">
                The operating system for application publishing, from intake to settlement.
              </p>
            </div>
            <div>
              ...
              <div className="mt-5 grid gap-3 text-sm text-white/50">
                ...
                <a href="#publishing" className="transition hover:text-white">
                  Publishing
                </a>
            ...
            <div>
              ...
              <div className="mt-5 grid gap-3 text-sm text-white/50">
                <a href="mailto:hello@fonitas.com" className="transition hover:text-[#ff6a2a]">
                  hello@fonitas.com
                </a>
