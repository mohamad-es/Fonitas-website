      ...
      <section id="solutions" className="mx-auto max-w-[1400px] px-6 py-28 lg:px-10 lg:py-40">
        <div className="grid gap-16 lg:grid-cols-[.8fr_1.2fr]">
          ...
          <div className="border-t border-white/10">
            {solutions.map(([number, title, description]) => <div key={number} className="group grid gap-6 border-b border-white/10 py-9 sm:grid-cols-[80px_1fr_1fr]"><span className="text-xs text-white/30">{number}</span><h3 className="text-2xl font-medium transition group-hover:text-[#ff6a2a]">{title}</h3><p className="max-w-md text-sm leading-6 text-white/45">{description}</p></div>)}
          </div>
        </div>
      </section>
