        ...
        <div className="relative mx-auto grid max-w-[1400px] items-center gap-12 px-6 py-14 sm:py-16 lg:grid-cols-[1.05fr_.95fr] lg:gap-6 lg:px-10 lg:py-20">
          <div className="relative z-10">
            ...
            <h1 className="font-display glow-text reveal-up reveal-delay-1 max-w-5xl text-[clamp(4rem,9vw,9.5rem)] font-semibold leading-[0.84]">
              ...
              {t("application")}
              <br />
              <span className="text-white/30">{t("to market")}</span>
            </h1>
        ...
        <div className="mx-auto grid max-w-[1400px] gap-10 px-6 py-20 lg:grid-cols-[.7fr_1.3fr] lg:px-10 lg:py-28">
          <div>
            ...
            <h2 className="font-display max-w-xl text-5xl font-semibold leading-[.92] sm:text-7xl">
              {t("More than publishing")}
            </h2>
          </div>
          <div className="max-w-3xl text-lg leading-8 text-white/45 sm:text-xl">
            <p>
              {t(
                "Fonitas connects the operational work around your application so your team can move from collaboration to publishing and financial close through one clear lifecycle"
              )}
            </p>
            <p className="mt-6">
              {t(
                "The result is a controlled process with visible responsibility at every stage — without turning your public-facing journey into another complicated platform"
              )}
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-[1400px] px-6 py-24 sm:py-28 lg:px-10 lg:py-36">
          <div className="flex flex-col gap-7 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              ...
              <h2 className="font-display max-w-3xl text-5xl font-semibold leading-[.9] sm:text-7xl">
                {t("One path")}
                <br />
                <span className="text-white/30">{t("Nine stages")}</span>
              </h2>
            </div>
            <p className="max-w-sm text-sm leading-6 text-white/35 lg:pb-1">
              {t(
                "Explore the journey from collaboration to financial close. Each stage has a clear state, responsibility and next step"
              )}
            </p>
          </div>
          <LifecycleWizard />
          ...
          <div className="mb-12 flex items-end justify-between gap-6 sm:mb-14">
            <div>
              ...
              <h2 className="font-display max-w-4xl text-5xl font-semibold leading-[.9] sm:text-7xl">
                {t("One core")}
                <br />
                <span className="text-white/30">{t("Many capabilities")}</span>
              </h2>
            </div>
          </div>
          <InsightsShowcase />
      ...
      <footer className="border-t border-white/[0.08] bg-[#070707]">
        <div className="mx-auto max-w-[1400px] px-6 py-14 lg:px-10 lg:py-16">
          <div className="grid gap-12 md:grid-cols-[1.3fr_.7fr_.7fr_.7fr]">
            <div>
              <Link href="/" className="text-2xl font-bold tracking-[-.05em]">
                Fonitas<span className="text-[#ff5a1f]">.</span>
              </Link>
              <p className="mt-5 max-w-xs text-sm leading-6 text-white/35">
                {t("The operating system for application publishing, from intake to settlement")}
              </p>
            </div>
            <div>
