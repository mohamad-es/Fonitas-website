    ...
    <main id="main-content" tabIndex={-1} className="overflow-hidden">
      ...
      <section className="relative border-b border-white/[0.08] pt-20">
        ...
        <div className="relative mx-auto grid max-w-[1400px] items-center gap-12 px-6 py-14 sm:py-16 lg:grid-cols-[1.05fr_.95fr] lg:gap-6 lg:px-10 lg:py-20">
          <div className="relative z-10">
            <p className="reveal-up mb-8 text-xs font-semibold uppercase tracking-[0.28em] text-[#ff6a2a]">For product owners</p>
      ...
      <section className="border-b border-white/[0.08]">
        <div className="mx-auto grid max-w-[1400px] gap-10 px-6 py-20 lg:grid-cols-[.7fr_1.3fr] lg:px-10 lg:py-28">
          <div>
            <p className="mb-5 text-xs uppercase tracking-[0.25em] text-[#ff5a1f]">For application owners</p>
            <h2 className="font-display max-w-xl text-5xl font-semibold leading-[.92] sm:text-7xl">More than publishing.</h2>
          </div>
          <div className="max-w-3xl text-lg leading-8 text-white/45 sm:text-xl">
            <p>Fonitas connects the operational work around your application so your team can move from collaboration to publishing and financial close through one clear lifecycle.</p>
            <p className="mt-6">The result is a controlled process with visible responsibility at every stage — without turning your public-facing journey into another complicated platform.</p>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-white/[0.08] bg-[#070707]">
        <div className="mx-auto max-w-[1400px] px-6 py-14 lg:px-10 lg:py-16">
          <div className="grid gap-12 md:grid-cols-[1.3fr_.7fr_.7fr_.7fr]">
            ...
            <div>
              <p className="text-[10px] uppercase tracking-[.22em] text-white/25">Product owners</p>
              <div className="mt-5 grid gap-3 text-sm text-white/50">
                ...
                <a href="#platform" className="transition hover:text-white">Capabilities</a>
