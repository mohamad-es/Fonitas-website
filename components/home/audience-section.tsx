      ...
      <div className="mx-auto max-w-[1400px] px-6 py-28 lg:px-10 lg:py-40">
        ...
        <div className="mt-16 border-y border-white/10">
          {audiences.map(([number, title, description, action], index) => (
            <article key={number} className="group relative grid gap-6 border-b border-white/10 py-8 last:border-b-0 sm:grid-cols-[70px_1fr_auto] sm:items-center sm:py-10">
