...
const stages = [
  ...
  ["04", "Settlement", "{t("Settlement records close the financial obligation.")}"],
              ...
              <div className="grid lg:grid-cols-[190px_1fr]">
                ...
                <div className="relative min-h-[360px] p-6 sm:min-h-[430px] sm:p-10">
                  ...
                  <div className="relative flex h-full flex-col">
                    <div className="flex items-center justify-between gap-4 text-[9px] uppercase tracking-[.2em]"><span className="text-[#ff6a2a]">{stage[0]} / {stage[1]}</span><span className="text-white/20">{t("Financial fact")}</span></div>
