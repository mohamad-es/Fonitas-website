...
export function HeroOrbit() {
  ...
  return (
    <div ref={ref} className="hero-orbit group relative mx-auto w-full max-w-[620px] select-none [perspective:1200px] sm:px-2" aria-hidden="true">
      ...
      <div className="relative z-10 mx-auto w-[94%] py-8 transition-transform duration-500 ease-out sm:py-10" style={{ transform: "translate3d(var(--mx,0px),var(--my,0px),0) rotateX(var(--rx,0deg)) rotateY(var(--ry,0deg))", transformStyle: "preserve-3d" }}>
        <div className="grid gap-3 sm:gap-4">
          <div className="flex items-start gap-3 rounded-[24px] sm:items-center sm:gap-4 border border-white/10 bg-[#0d0d0d]/90 p-5 shadow-[0_20px_80px_rgba(0,0,0,.35)] backdrop-blur-xl sm:p-6">
            ...
            <span className="ml-auto shrink-0 rounded-full border border-white/10 px-2.5 py-1.5 text-[8px] font-medium uppercase tracking-[.14em] text-white/45 sm:px-3 sm:text-[9px]">{t("Ready")}</span>
          </div>

          <div className="flex justify-center py-1 text-[#ff5a1f]"><div className="flex h-8 w-8 items-center justify-center rounded-full border border-[#ff5a1f]/25 bg-[#ff5a1f]/[.06] text-sm text-[#ff6a2a]">↓</div></div>
          ...
          <div className="relative overflow-hidden rounded-[30px] border border-[#ff5a1f]/30 bg-[#ff5a1f]/[0.045] p-7 shadow-[0_25px_90px_rgba(255,90,31,.09)] transition-transform duration-700 group-hover:[transform:translateZ(14px)_rotateX(1deg)] sm:p-8">
            ...
            <div className="relative flex flex-col items-center text-center">
              <div className="flex h-20 w-20 animate-[pulse_4s_ease-in-out_infinite] sm:h-28 sm:w-28 items-center justify-center rounded-[26px] bg-[#ff5a1f] text-sm font-black tracking-[.12em] text-black shadow-[0_0_55px_rgba(255,90,31,.32)] ring-1 ring-white/20 transition-transform duration-700 group-hover:scale-[1.04]">FONITAS</div>
              <p className="mt-5 text-[11px] font-semibold uppercase tracking-[.22em] text-white/85">{t("Publishing Operating System")}</p>
              <p className="mt-2 max-w-sm text-xs leading-6 text-white/35 sm:text-sm">{t("Review · Contract · QA · Publishing · Revenue · Settlement")}</p>
            </div>
          </div>

          <div className="flex justify-center py-1 text-[#ff5a1f]"><div className="flex h-10 w-10 items-center justify-center rounded-full border border-[#ff5a1f]/30 bg-[#ff5a1f]/10 text-lg">↓</div></div>
          ...
          <div className="rounded-[24px] border border-white/10 bg-[#0d0d0d]/90 p-5 shadow-[0_20px_80px_rgba(0,0,0,.35)] backdrop-blur-xl sm:p-6">
            <div className="mb-4 flex items-center justify-between">
              <p className="text-[10px] font-semibold uppercase tracking-[.22em] text-[#ff6a2a]">{t("Publishing destinations")}</p>
