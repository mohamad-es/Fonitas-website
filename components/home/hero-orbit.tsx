      ...
      >
        <div className="grid gap-3 sm:gap-4">
          <div className="flex items-start gap-3 rounded-[24px] sm:items-center sm:gap-4 border border-white/10 bg-[#0d0d0d]/90 p-5 shadow-[0_20px_80px_rgba(0,0,0,.35)] backdrop-blur-xl sm:p-6">
            ...
            <span className="ml-auto shrink-0 rounded-full border border-white/10 px-2.5 py-1.5 text-[8px] font-medium uppercase tracking-[.14em] text-white/45 sm:px-3 sm:text-[9px]">Ready</span>
          </div>
