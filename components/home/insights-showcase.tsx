...
function RoadmapVisual({ type }: { type: string }) {
  if (type === "commercial") {
    return (
      <div className="relative min-h-[420px] overflow-hidden bg-[#0d0d0d] p-7 lg:h-[500px]">
        ...
        <div className="absolute left-1/2 top-1/2 flex h-16 w-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-2xl bg-[#ff5a1f] text-[9px] font-semibold tracking-[.16em] text-black shadow-[0_0_70px_rgba(255,90,31,.35)]">{t("CORE")}</div>
  ...
  if (type === "growth") {
    return (
      <div className="relative min-h-[230px] overflow-hidden bg-[#101010] p-6">
        ...
        <div className="absolute left-7 top-7 rounded-full border border-white/10 bg-[#0b0b0b]/90 px-3 py-2 text-[8px] uppercase tracking-[.18em] text-[#ff6a2a]">{t("Promotion signals")}</div>
        <div className="absolute bottom-7 right-7 rounded-full border border-white/10 bg-[#0b0b0b]/90 px-3 py-2 text-[8px] uppercase tracking-[.18em] text-white/35">{t("Future")}</div>
      </div>
    );
  }
  ...
  return (
    <div className="relative min-h-[230px] overflow-hidden bg-[#0d0d0d] p-6">
      ...
      <div className="absolute left-1/2 top-1/2 flex h-12 w-12 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-xl bg-[#ff5a1f] text-[7px] font-semibold tracking-[.12em] text-black">{t("API")}</div>
